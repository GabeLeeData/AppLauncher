package gabriellee.project.applauncher.Fragment;
...
import gabriellee.project.applauncher.R;

public class AppLauncherFragment extends Fragment {

    private static final String TAG = "AppLauncherFragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_app_launcher, container, false);
    ...
    //Adapter - Retrieving info for App on phone
    ...
    //View Holder to store the activity - Recycler
    ...
    //Adapter - Communicating with Recycler
